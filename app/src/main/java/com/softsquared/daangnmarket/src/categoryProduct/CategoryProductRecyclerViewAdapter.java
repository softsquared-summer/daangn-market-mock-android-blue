...
public class CategoryProductRecyclerViewAdapter extends RecyclerView.Adapter<CategoryProductRecyclerViewAdapter.ViewHolder> {
    private ArrayList<ResponseCategoryProduct.Result> mData;
    ...
    public CategoryProductRecyclerViewAdapter(ArrayList<ResponseCategoryProduct.Result> arrayList) {
        mData = arrayList;
    }

    @NonNull
    @Override
    public CategoryProductRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        View view = inflater.inflate(R.layout.product_recycler_view_item, parent, false);
        CategoryProductRecyclerViewAdapter.ViewHolder vh = new CategoryProductRecyclerViewAdapter.ViewHolder(view);

        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryProductRecyclerViewAdapter.ViewHolder holder, int position) {
