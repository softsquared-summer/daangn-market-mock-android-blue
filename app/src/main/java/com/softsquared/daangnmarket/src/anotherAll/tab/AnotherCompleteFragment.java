...
public class AnotherCompleteFragment extends Fragment implements AnotherAllActivityView {
    ...
    public AnotherCompleteFragment(int userNo) {
        mUserNo = userNo;
        mPageNo = 1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_another_complete, container, false);

        mRecyclerView = view.findViewById(R.id.another_complete_recycler_view);
    ...
    public void getAnotherProduct(int userNo, int pageNo) {
        ...
        anotherAllService.getAnotherProductStatus(userNo, 'Y', pageNo);
    }
