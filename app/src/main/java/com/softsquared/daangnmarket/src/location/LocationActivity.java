...
public class LocationActivity extends BaseActivity implements LocationActivityView {
    ...
    String mLocation_x, mLocation_y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentAddressButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                mLocation_x = Double.toString(latitude);
                mLocation_y = Double.toString(longitude);
                System.out.println(mLocation_x + " " + mLocation_y);
                getCurAddress();
            }
        });
    }
    ...
    public void getCurAddress() {
        LocationService locationService = new LocationService(this);
        locationService.getCurAddress(mLocation_x, mLocation_y);
    }
