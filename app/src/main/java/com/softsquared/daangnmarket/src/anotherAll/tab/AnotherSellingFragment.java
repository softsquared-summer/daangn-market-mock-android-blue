...
public class AnotherSellingFragment extends Fragment implements AnotherAllActivityView {
    ...
    public AnotherSellingFragment(int userNo) {
        mUserNo = userNo;
        mPageNo = 1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_another_selling, container, false);

        mRecyclerView = view.findViewById(R.id.another_selling_recycler_view);
    ...
    public void getAnotherProduct(int userNo, int pageNo) {
        ...
        anotherAllService.getAnotherProductStatus(userNo, 'N', pageNo);
    }
